...
public class ComsumerContentBatch implements Runnable {

    private String url;
    private String indexName;
    public ComsumerContentBatch(String url,String indexName){
    ...
    public void run() {
        ...
        try {
            ...
            int retryTimes = 0;
            while (true){
                List<DocContent> docContents = DataQueue.getDocContentQueue(250);
                if (docContents == null){
                    if (retryTimes > 5){
